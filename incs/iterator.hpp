...
namespace ft
{
	//issue : ptrdiff_t -> __gnu_cxx::ptrdiff_t 변경 (-std=c++98 옵션이 문제로 보임, vector도 마찬가지)
	...
	struct iterator_traits<T*>
	{
		...
		typedef T							value_type;
		typedef typename __gnu_cxx::ptrdiff_t					difference_type;
		typedef T*							pointer;
		typedef T&							reference;
	};
	...
	*/
	...
	/////////////////////////istream_iterator///////////////////////////////
	template <class T, class charT=char, class traits=std::char_traits<charT>, class Distance=__gnu_cxx::ptrdiff_t>
